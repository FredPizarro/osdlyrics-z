# -*- coding: utf-8 -*-
"""
main.py — Punto de entrada para OSD Lyrics + AIMP en Windows.
...
# Asegurarse de que el directorio del paquete esté en el PATH
...
def cmd_launch_osd():
    ...
    # Verificar que pyaimp esté instalado
    try:
        import pyaimp  # noqa: F401
    except ImportError:
        print("ERROR: pyaimp no está instalado.")
        print("Instala las dependencias con:")
        print("    uv pip install -r requirements.txt")
        print("  o ejecuta: instalar.bat")
        sys.exit(1)
    ...
    print("Iniciando OSD Lyrics para AIMP...")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='OSD Lyrics para AIMP — Letras sincronizadas en Windows',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Ejemplos:
  python main.py                                  # Lanzar OSD
  python main.py --test-lrc                       # Probar parser
  python main.py --test-fetch "Bohemian Rhapsody" "Queen"
  python main.py --test-fetch "Shape of You" "Ed Sheeran" --no-cache
