...
Adaptado del módulo osdlyrics/lrc.py para funcionar sin D-Bus en Windows.
"""
...
def parse_lrc(content):
    ...
    for token in tokens:
        if isinstance(token, AttrToken):
            ...
            # Siempre descartar los timetags procesados,
            # aunque el texto estuviera vacío, para no asociarlos
            # con el siguiente StringToken.
            timetags = []
